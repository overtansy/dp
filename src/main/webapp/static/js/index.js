...
var vm = new Vue({
	...
	methods : {
		...
		// @author 老医组 LHB
		topMenuRoute : function(){
			$(".dropdown div div div ul a").off('click').on('click', function(e){
				// 跳转
				url = $(this).context.href;
				vm.main = url.substring( url.lastIndexOf("#") +1 );
				
				// 隐藏下拉菜单
				$(".dropdown-menu.animated").css("display","none");
			});
		}
